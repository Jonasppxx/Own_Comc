...
def extract_guids_from_file(xml_file):
    ...
    for item in root.findall(".//item"):
        ...
        # Speichere die Karte nur, wenn der Kartennamen nicht "N/A" und der Sale-Preis über 3.00 USD ist
        if cleaned_card_name != "N/A" and sale_price > 2:
            card_info = {
                'guid': guid,
                'salePrice': sale_price,
                'cardNumber': card_number,
                'cardName': cleaned_card_name  # Entferne das Set-Feld hier
            }
...
if __name__ == "__main__":
    folder_path = r'C:\Users\jonas\OneDrive\Desktop\Own_comc\rss_files'
    output_file = '2cards_data.json'
