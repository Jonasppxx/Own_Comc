...
def calculate_percentage_difference(value1, value2):
    ...
    :return: Prozentsatz der Ungleichheit
    """
    # Konvertiere die Werte zu float, um die Berechnung durchzuführen
    value1 = float(value1)
    value2 = float(value2)
    
    # Bestimme den größeren Wert
    ...
    # Berechne den Prozentsatz der Ungleichheit
...
def main():
    ...
    """
    input_file = r'C:\Users\jonas\OneDrive\Desktop\Own_comc\4filtered_cards_info.json'  # Der Pfad zur JSON-Datei
    output_file = r'C:\Users\jonas\OneDrive\Desktop\Own_comc\5sorted_cards_by_difference.json'  # Der Pfad zur Ausgabedatei
